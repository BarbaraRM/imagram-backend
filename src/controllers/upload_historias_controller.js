...
const storage_historia = multer.diskStorage({
    ...
    */
    destination: function (req, file, cb) {
        ...
        if (file_type === '.mp4') {
            cb(null, process.env.HOME + '/publicaciones/historias/videos')
        }

        if (file_type === '.jpg' || file_type === '.png' || file_type === '.jpeg') {
            cb(null, process.env.HOME + '/publicaciones/historias/imagenes')
        }
    },
...
const upload_historia = multer({
    storage: storage_historia,
...
module.exports = upload_historia;