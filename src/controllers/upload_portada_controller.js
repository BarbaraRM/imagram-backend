...
const storage_portada = multer.diskStorage({
    ...
    */
    destination: function (req, file, cb) {
        ...
        if (file_type === '.mp4') {
            cb(null, process.env.HOME + '/publicaciones/portada/videos')
        }

        if (file_type === '.jpg' || file_type === '.png' || file_type === '.jpeg') {
            cb(null, process.env.HOME + '/publicaciones/portada')
        }
    },
    ...
    */
    filename: function (req, file, cb) {
        ...
        if (file_type === '.mp4') {
            file_type = '.mp4'
            file_name = 'vid_portada_';
        }

        if (file_type === '.jpg' || file_type === '.png' || file_type === '.jpeg') {
            file_type = '.jpg'
            file_name = 'img_portada_';
        }
...
const upload_portada = multer({
    storage: storage_portada,
